     ...
     if ($in::exists()) {
        ...
        if ($validation->passed()) {
            ...
            try {
                ...
                Session::flash('request', " <div class='alert alert-success'> your Request sent   Successfull </div> ");
        ...
        <h3>step 1</h3>
                ...
                <form class="signup-page" action="" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="form-group" >
                        ...
                        <div  id="div_name">
                            <input type="text" class="form-control margin-bottom-20" id="org_name" name="org_name" placeholder="Enter organization name" 
                                   value="<?php echo escape(Input::get('org_name')) ?>"  required    >
                    ...
                    <div class="form-group">
                        ...
                        <div >
                            <input type="text" class="form-control margin-bottom-20" id="org_phone"  name="org_phone" placeholder="Enter phone number" 
                                value="<?php echo escape(Input::get('org_phone')) ?>"  required  >
                    ...
                    <div class="form-group">
                        ...
                        <div >
                            <input  class="form-control margin-bottom-20" id="org_location" name="org_location" placeholder="Enter city" 
                              value="<?php echo escape(Input::get('org_location')) ?>"  required>
                    ...
                    <div class="form-group">
                        ...
                        <div >
                            <input name="auto_paper" type="file"  id="org_paper" required  >
                            <span class="help-block"><p>That Shows Organization's Identity With Legal patent/license</p> </span>
                        </div>
                    </div>
